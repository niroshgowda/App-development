...
export default function Home() {
  ...
  <section id="sellers">
    <div className="seller container">
      ...
      <div className="best-seller">
        <div className="best-p1">
          <img src="https://www.findingtheuniverse.com/wp-content/uploads/2016/04/Paris252520falling252520into252520dusk252520Eiffel252520Tower_by_Laurence252520Norah25255B425255D.jpg" alt="img" />
          <div className="best-p1-txt">
            <div className="name-of-p">
        ...
        <div className="best-p1">
          <img src="https://images.squarespace-cdn.com/content/v1/569e766e69492e9dd5373ef6/1556016297737-7BZLAV83VOV0BS9VQUQH/_ABX2402.jpg?format=2500w" alt="img" />
          <div className="best-p1-txt">
            <div className="name-of-p">
